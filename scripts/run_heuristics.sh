...
python src/compute_metrics.py --predictions ${output_dir}/default/copy_demo/predicted_examples.jsonl --track default --compute_per_category_metrics --compute_per_task_metrics
...
python src/compute_metrics.py --predictions ${output_dir}/default/copy_input/predicted_examples.jsonl --track default --compute_per_category_metrics --compute_per_task_metrics
